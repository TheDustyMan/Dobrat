...
class GlobalView extends JPanel implements ActionListener{
    ...
    public GlobalView(){
        ...
        scienceBar.setString("Research " + scienceValue+ "%");
        scienceBar.setStringPainted(true);
        scienceBar.setValue(scienceValue);
        
        // Labels
        yearLabel = new JLabel("1990 ");
        scienceLabel = new JLabel("Research: Sailing ");
