...
public class PhysicalUnitView extends JPanel implements Observer, ActionListener{
    ...
    private JButton defButton = new JButton("Defend");
    private JButton moveButton = new JButton("Move");
    private JButton infoButton = new JButton("Show more info");
    ...
    private JPanel createUpperPane(){
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Battle:"));
    ...
    private void updateAlly(){
        ...
        manPower.setString("manpower: " + 
                (int)((double)pUnit.getManPower() / pUnit.getType().getMaxManPower() * 100) +
                "%");
        manPower.setStringPainted(true);
        defence.setText("Defence: " + pUnit.getType().getDefence());
        range.setText("Range: " + pUnit.getType().getRange());
        attack.setText("Attackpower: " + pUnit.getType().getAttack());
        movement.setText("Movement: " + pUnit.getCurrentMovementPoint() + 
                "/" + pUnit.getType().getMovementPoints());
        
        lifeLength.setMaximum(pUnit.getType().getInventorySize());
        lifeLength.setString("Life: "+ Integer.toString(pUnit.getInventoryAmount()));
