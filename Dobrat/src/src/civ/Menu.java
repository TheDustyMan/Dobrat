...
import static src.civ.State.HoverState.HoverNone;
import static src.civ.State.HoverState.HoverTileOnly;
import static src.civ.State.HoverState.HoverTileUnit;
...
public class Menu extends JPanel implements Observer, ActionListener{
    ...
    Menu(){ 
        ...
        tabbedPane.addTab(" Hey ", null, unitView, "No object selected ");
    ...
    private void update(){
            ...
            case HoverTileUnit:
                ...
                if(state.getHoverTile().getUnit().isAlly()){
                    tileLabel.setText("<html>Terrain: " + outputTerrain +
                            ...
                            " Seizure: " + state.getHoverTile().getUnit().getType().getAttack() + 
                            " -Placeholder-: " + state.getHoverTile().getUnit().getType().getDefence() + 
            ...
            case UnitSelected: 
                if(state.getSelectedUnit().isAlly()){
                    PhysicalUnit unit = state.getSelectedUnit();
                 	...
                 	tabbedPane.addTab(unitTypeName, null, unit.getView(), "Show your units ");
                }
                break;
        ...
        switch (state.getCityState()) {
        	case CitySelected:
        		...
        		tabbedPane.addTab(cityName, null, city.getView(), "Show your places ");
